...
import '../base/base_feed.dart';


class BaseFeed extends StatefulWidget {
  const BaseFeed({Key? key}) : super(key: key);

  @override
  State<BaseFeed> createState() => _BaseFeedState();
}

class _BaseFeedState extends State<BaseFeed> {
